...
OUTPUT_FILENAME = 'C:/Users/Cong/PycharmProjects/CrawlBaomoi/tutorial/tutorial/Output/BaoMoi.txtoutput/sosanhgia/sosanhgia{}.txt'.format(datetime.now().strftime('%Y%m%d_%H%M%S'))
